...
class PhraseTrigger(Trigger):
    ...
    def is_phrase_in(self, text):
        ...
        match = re.search(r'\b'+ self.phrase +r'\b', text)
...
class BeforeTrigger(TimeTrigger):
    ...
    def evaluate(self,Newsstory):
        ...
        if Newsstory.get_pubdate()<self.time:
            return True
        else:
            return False
...
def read_trigger_config(filename):
    ...
    for line in lines:
        if line[0]!='ADD':
            if len(line)==3:
                variables[line[0]]=triggers[line[1]](line[2])
            else:
                variables[line[0]]=triggers[line[1]](variables[line[2]],variables[line[3]])
        else:
            trigger_list[:] += [variables[variable] for variable in line[1:]]
...
def main_thread(master):
    ...
    try:
        ...
        t2 = DescriptionTrigger("Harry")
        t3 = DescriptionTrigger("Meghan")
        t4 = AndTrigger(t2, t3)
        triggerlist = [t1, t4]
